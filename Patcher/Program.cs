        ...
        static void Main(string[] args)
        {
            if(args.Length == 0)
            {
                Console.Write("Error: Please provide valid arguments!\n\n" +
                                "Usage: Patcher.exe <GameFile> <switch>\n" +
                                "Switches:\n" +
            ...
            if (Patcher.PatchGameFile())
                Console.WriteLine($"Successfully patched {Patcher.OriginalGameFile}");
        }
    }
}
